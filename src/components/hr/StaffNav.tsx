...
const NAV = [
  { href: "/staff/checklist", label: "เช็คลิสต์", icon: "✅" },
  { href: "/staff/tasks", label: "งาน", icon: "📋" },
  { href: "/staff/kpi", label: "KPI", icon: "🎯" },
  { href: "/staff/dashboard", label: "ภาพรวม", icon: "📊", ownerOnly: true },
];
