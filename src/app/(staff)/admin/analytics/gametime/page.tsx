      ...
      {!isLoading && sorted.length > 0 && (
        <div className="grid grid-cols-2 gap-3 mb-4">
          <div className="bg-white rounded-2xl shadow-sm p-4">
            <p className="text-xs text-gray-400 mb-1">จำนวนใช้บริการ</p>
            <p className="text-2xl font-bold text-navy">{totalQty.toLocaleString()}</p>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-sand text-xs text-gray-400">
              ...
              <th className="text-left p-3">แพ็กเกจ</th>
              <th
