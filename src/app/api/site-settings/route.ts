...
const ALLOWED_KEYS = ["promo_title", "promo_body", "promo_enabled", "print_receipt", "print_kitchen", "menu_categories", "business_hours", "alert_sound_url", "kitchen_sound_url"] as const;
